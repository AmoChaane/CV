...
export default class SideInfo extends React.Component {
    ...
    render() {
        return <div className="sideInfo">
            ...
            <Skills state={this.props.state} text={this.props.text} click={this.props.click} delete={this.props.delete} add={this.props.add} handle={this.props.handle} addSkill={this.props.addSkill} showSkillBox={this.props.showSkillBox} showEducationBox={this.props.showEducationBox} editSkillItem={this.props.editSkillItem} showSkillBoxEdit={this.props.showSkillBoxEdit}/>
